...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{experiment_3_rzut}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{experiment_3_plot}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{experiment_3_comp}
    \caption{Porównanie obrazu z rzutem}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{experiment_4_rzut}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.33]{experiment_4_plot}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{experiment_4_comp}
    \caption{Porównanie obrazu z rzutem}
